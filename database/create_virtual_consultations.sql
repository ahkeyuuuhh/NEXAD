...
-- Teachers can view their own consultations
...
CREATE OR REPLACE FUNCTION expire_old_consultations()
RETURNS void AS $$
BEGIN
...
-- Auto-expire consultations (run periodically)
...
INSERT INTO virtual_consultations (
  ...
  'test-room-123',
  'https://nexad.daily.co/test-room-123',
  'ABC123',
  (SELECT user_id FROM teacher_profiles LIMIT 1),
  'Test Teacher',
  'active'
);
*/
