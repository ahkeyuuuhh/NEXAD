...
echo "   - build-ios-android.sh (Build apps)"
echo "   - update-website-links.sh (Update website)"
echo "   - show-build-status.sh (This script)"
echo ""
