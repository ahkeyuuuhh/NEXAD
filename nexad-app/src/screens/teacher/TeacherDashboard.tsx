      ...
      <Modal visible={showProfileMenu} transparent animationType="fade" onRequestClose={() => setShowProfileMenu(false)}>
        <TouchableOpacity style={styles.profileOverlay} activeOpacity={1} onPress={() => setShowProfileMenu(false)}>
          <View style={styles.profileMenu}>
            ...
            <TouchableOpacity style={styles.profileMenuItem} onPress={() => { setShowProfileMenu(false); navigation.navigate('TeacherProfile', { userId: userId, isOwnProfile: true }); }}>
...
const styles = StyleSheet.create({
  ...
  requestCard: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#F4F4F4', // Match dashboard background exactly
    borderRadius: R.xl,
    padding: S.lg,
    marginBottom: S.md,
    borderWidth: 0,
